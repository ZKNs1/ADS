function alterar_texto() {
    ...
    document.querySelectorAll("p")[1].innerHTML = "Query selector"; //o segundo vai mudar, determinado no array
    document.querySelector("p").innerHTML = "Query selector";
    document.querySelector("#hello").innerHTML = "Query selector id"; //ID
    document.querySelector(".dom").innerHTML = "Query selector class"; //Class
